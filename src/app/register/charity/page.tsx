    ...
    <div className="relative w-full h-screen flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: "url('/bg.jpg')" }}>
      ...
      >
        ...
        >
          ...
          <input type="text" placeholder="Organization Name" name="organizationName" value={formData.organizationName} onChange={(e) => setFormData({ ...formData, organizationName: e.target.value })} className="w-full p-3 border rounded-lg bg-white/30 text-white placeholder-white" required />
        ...
        <motion.p initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.6 }} className="mt-6 text-white/80">
          ...
          <Link href="/login/charity" className="text-white font-semibold underline">
            Login here
          </Link>
        </motion.p>
      </motion.div>
